package com.example.yuntukuh.manager.auth;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    private  SpaceUserAuthContext getAuthContextByRequest() {
        ...
        //获取请求参数,如果为get请求,如果请求参数为json格式，则从请求体中获取参数
        ...
        if(ObjUtil.isNotNull(id)){
            ...
            //获取请求路径的前缀，如果是/api/spaceuser/auth/login,则id为spaceUserId
            //将api替换为空字符串，得到spaceuser/auth/login
            String pathURI = requestURI.replace(contextPath + "/", "");
            //获取第一个“/”前的字符串
            String modelName = StrUtil.subBefore(pathURI, "/", false);
            switch (modelName){
                case "spaceUser":
