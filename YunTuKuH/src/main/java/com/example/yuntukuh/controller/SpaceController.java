...
import com.example.yuntukuh.model.dto.space.*;
...
public class SpaceController {
    ...
    public BaseResponse<Long> addSpace(@RequestBody spaceAddRequest spaceAddRequest, HttpServletRequest request){
        ...
        Long addedSpace = spaceService.addSpace(spaceAddRequest, userLogin);
    ...
    public BaseResponse<Boolean> deleteSpace(@RequestBody DeleteRequest deleteRequest,HttpServletRequest request){
        ...
        //仅本人和管理员可删除
        spaceService.checkSpaceAuth(oldspace,userLogin);
    ...
    public BaseResponse<SpaceVO> getSpaceVOById(long id, HttpServletRequest request) {
        ...
        // 查询数据库
        Space space = spaceService.getById(id);
        ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR,"空间为空");
