...
import com.example.yuntukuh.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest) {
        ...
        //默认密码
        final String MORENPASSWORD="12345678";
        String miwen= userService.getEncryptPassword(MORENPASSWORD);
